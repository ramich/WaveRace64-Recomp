...
| `WR64_HUD=stretch` | Stretch HUD elements with the window in widescreen instead of keeping them proportional/centered (default: centered, requires `WR64_BORDERS=0` for the compensation to engage) |
