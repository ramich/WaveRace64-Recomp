...
| `WR64_CRT_BEZEL=0` | Disable the **CRT Bezel** (also a launcher **Enhancements** toggle, default on): a TV frame with recessed depth shading and a soft screen reflection around the picture. Fixed strength — independent of the `WR64_CRT` intensity |
